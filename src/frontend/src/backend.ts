...
export class Backend implements backendInterface {
    ...
    async deactivateNumber(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deactivateNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveNumbers(): Promise<Array<PhoneNumber>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveNumbers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPhoneNumbers(): Promise<Array<PhoneNumber>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPhoneNumbers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessagesForNumber(arg0: string): Promise<Array<SMSMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagesForNumber(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNumbersByState(arg0: string): Promise<Array<PhoneNumber>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNumbersByState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
